  ...
  {"items":
   [("view3d.cursor3d", {"type": 'LEFTMOUSE', "value": 'CLICK'}, None),
    ...
    ("view3d.view_selected",
     {"type": 'NUMPAD_PERIOD', "value": 'PRESS', "oskey": True, "repeat": True},
     {"properties":
    ...
    ("view3d.navigate", {"type": 'F', "value": 'PRESS', "repeat": True}, None),
    ...
    ("view3d.view_axis",
     {"type": 'NUMPAD_1', "value": 'PRESS', "oskey": True, "repeat": True},
     {"properties":
      [("type", 'BACK'),
       ],
      },
    ...
    ("view3d.view_axis",
     {"type": 'NUMPAD_3', "value": 'PRESS', "oskey": True, "repeat": True},
     {"properties":
      [("type", 'LEFT'),
       ],
      },
    ...
    ("view3d.view_axis",
     {"type": 'NUMPAD_7', "value": 'PRESS', "oskey": True, "repeat": True},
     {"properties":
      [("type", 'BOTTOM'),
       ],
      },
    ...
    ("view3d.view_axis",
     {"type": 'NUMPAD_1', "value": 'PRESS', "shift": True, "oskey": True, "repeat": True},
     {"properties":
      [("type", 'BACK'),
       ("align_active", True),
       ],
    ...
    ("view3d.view_axis",
     {"type": 'NUMPAD_3', "value": 'PRESS', "shift": True, "oskey": True, "repeat": True},
     {"properties":
      [("type", 'LEFT'),
       ("align_active", True),
       ],
    ...
    ("view3d.view_axis",
     {"type": 'NUMPAD_7', "value": 'PRESS', "shift": True, "oskey": True, "repeat": True},
     {"properties":
      [("type", 'BOTTOM'),
       ("align_active", True),
       ],
    ...
    ("view3d.render_border", {"type": 'B', "value": 'PRESS', "oskey": True, "repeat": True}, None),
    ("view3d.render_border", {"type": 'B', "value": 'PRESS', "ctrl": True, "repeat": True}, None),
    ("view3d.clear_render_border", {"type": 'B', "value": 'PRESS', "alt": True, "oskey": True, "repeat": True}, None),
    ("view3d.clear_render_border", {"type": 'B', "value": 'PRESS', "ctrl": True, "alt": True, "repeat": True}, None),
    ("view3d.camera_to_view", {"type": 'NUMPAD_0', "value": 'PRESS', "alt": True, "oskey": True, "repeat": True}, None),
    ("view3d.camera_to_view", {"type": 'NUMPAD_0', "value": 'PRESS', "ctrl": True, "alt": True, "repeat": True}, None),
    ("view3d.object_as_camera", {"type": 'NUMPAD_0', "value": 'PRESS', "oskey": True, "repeat": True}, None),
    ...
    ("transform.skin_resize", {"type": 'A', "value": 'PRESS', "oskey": True, "repeat": True}, None),
 ...
 ("Font",
  ...
  {"items":
   [("font.style_toggle",
    ...
    ("font.style_toggle",
     {"type": 'U', "value": 'PRESS', "oskey": True, "repeat": True},
     {"properties":
      [("style", 'UNDERLINE'),
       ],
      },
    ...
    ("font.style_toggle",
     {"type": 'P', "value": 'PRESS', "oskey": True, "repeat": True},
     {"properties":
      [("style", 'SMALL_CAPS'),
       ],
      },
    ...
    ("font.select_all", {"type": 'A', "value": 'PRESS', "oskey": True, "repeat": True}, None),
    ("font.select_all", {"type": 'A', "value": 'PRESS', "ctrl": True, "repeat": True}, None),
    ("font.text_copy", {"type": 'C', "value": 'PRESS', "oskey": True, "repeat": True}, None),
    ("font.text_copy", {"type": 'C', "value": 'PRESS', "ctrl": True, "repeat": True}, None),
    ("font.text_cut", {"type": 'X', "value": 'PRESS', "oskey": True, "repeat": True}, None),
  ...
  {"items":
   [("screen.animation_step", {"type": 'TIMER0', "value": 'ANY', "any": True}, None),
    ...
    ("screen.workspace_cycle",
     {"type": 'PAGE_DOWN', "value": 'PRESS', "oskey": True, "repeat": True},
     {"properties":
      [("direction", 'NEXT'),
       ],
      },
    ...
    ("screen.workspace_cycle",
     {"type": 'PAGE_UP', "value": 'PRESS', "oskey": True, "repeat": True},
     {"properties":
      [("direction", 'PREV'),
       ],
      },
    ...
    ("render.render",
     {"type": 'F12', "value": 'PRESS', "oskey": True, "repeat": True},
     {"properties":
      [("animation", True),
       ("use_viewport", True),
       ],
    ...
    ("render.play_rendered_anim", {"type": 'F11', "value": 'PRESS', "oskey": True, "repeat": True}, None),
    ...
    ("screen.userpref_show", {"type": 'COMMA', "value": 'PRESS', "oskey": True, "repeat": True}, None),
    ],
   },
  ),
 ("Toolbar Popup",
 ...
 ("View2D",
  ...
  {"items":
   [("view2d.scroller_activate", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
    ...
    ("view2d.pan", {"type": 'SPACE', "value": 'PRESS', "repeat": True}, None),
 ...
 ("Window",
  ...
  {"items":
   [("wm.call_menu",
    ...
    ("wm.call_menu",
     {"type": 'O', "value": 'PRESS', "shift": True, "oskey": True, "repeat": True},
     {"properties":
    ...
    ("wm.open_mainfile", {"type": 'O', "value": 'PRESS', "oskey": True, "repeat": True}, None),
    ...
    ("wm.save_as_mainfile", {"type": 'S', "value": 'PRESS', "shift": True, "oskey": True, "repeat": True}, None),
    ("wm.save_as_mainfile", {"type": 'S', "value": 'PRESS', "shift": True, "ctrl": True, "repeat": True}, None),
    ("wm.quit_blender", {"type": 'Q', "value": 'PRESS', "oskey": True, "repeat": True}, None),
    ...
    ("wm.batch_rename", {"type": 'F2', "value": 'PRESS', "oskey": True, "repeat": True}, None),
